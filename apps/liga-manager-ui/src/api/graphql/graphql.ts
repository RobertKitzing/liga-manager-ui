...
export type PitchFragment = { __typename?: 'Pitch' } & Pick<
    Pitch,
    'id' | 'label' | 'location_longitude' | 'location_latitude'
> & {
        contact?: Maybe<
            { __typename?: 'Contact' } & Pick<
                Contact,
...
export type MatchFragment = { __typename?: 'Match' } & Pick<
    Match,
    | 'id'
    | 'home_score'
    | 'guest_score'
    ...
    | 'cancellation_reason'
> & {
        home_team: { __typename?: 'Team' } & Pick<
            Team,
            'id' | 'name' | 'logo_id' | 'created_at'
        > & {
                contact?: Maybe<
        ...
        guest_team: { __typename?: 'Team' } & Pick<
            Team,
            'id' | 'name' | 'logo_id' | 'created_at'
        > & {
                contact?: Maybe<
...
export type PenaltyFragment = { __typename?: 'RankingPenalty' } & Pick<
    RankingPenalty,
    'id' | 'reason' | 'created_at' | 'points'
> & {
...
export type RankingFragment = { __typename?: 'Season' } & Pick<Season, 'id'> & {
        ranking?: Maybe<
            { __typename?: 'Ranking' } & Pick<Ranking, 'updated_at'> & {
                    positions?: Maybe<
                        Array<
                            Maybe<
                                { __typename?: 'RankingPosition' } & Pick<
                                    RankingPosition,
                                    | 'sort_index'
                                    | 'number'
                                    | 'matches'
                    ...
                    penalties?: Maybe<
                        Array<
                            Maybe<
                                { __typename?: 'RankingPenalty' } & Pick<
                                    RankingPenalty,
                                    'id' | 'reason' | 'created_at' | 'points'
                                > & {
                                        team: { __typename?: 'Team' } & Pick<
...
export type AllSeasonsFragment = { __typename?: 'Season' } & Pick<
    Season,
    'id' | 'name' | 'state'
> & {
        match_days?: Maybe<
...
export type AllSeasonsHoFFragment = { __typename?: 'Season' } & Pick<
    Season,
    'id' | 'name' | 'state'
> & {
        match_days?: Maybe<
...
export type SeasonFragment = { __typename?: 'Season' } & Pick<
    Season,
    'id' | 'name' | 'state'
> & {
        teams?: Maybe<
...
export type MatchDayFragment = { __typename?: 'MatchDay' } & Pick<
    MatchDay,
    'id' | 'number' | 'start_date' | 'end_date'
> & {
        matches?: Maybe<
...
export type AllTournamentsFragment = { __typename?: 'Tournament' } & Pick<
    Tournament,
    'id' | 'name'
>;
...
export type ScheduleAllMatchesForSeasonMutationVariables = Exact<{
    season_id: Scalars['String'];
    match_appointments:
        | Array<InputMaybe<MatchAppointment>>
        | InputMaybe<MatchAppointment>;
}>;

export type ScheduleAllMatchesForSeasonMutation = Pick<
    Mutation,
...
export type ScheduleAllMatchesForMatchDayMutation = Pick<
    Mutation,
...
export type RemoveRankingPenaltyMutation = Pick<
    Mutation,
...
export type RemoveTeamFromSeasonMutation = Pick<
    Mutation,
...
export type CreateMatchesForSeasonMutation = Pick<
    Mutation,
    'createMatchesForSeason'
>;
...
export type CreateTournamentRoundMutation = Pick<
    Mutation,
    'setTournamentRound'
>;
...
export type AllEventQuery = {
    event?: Maybe<
        { __typename?: 'Event' } & Pick<Event, 'id' | 'occurred_at' | 'type'>
    >;
};
...
export type SeasonPenaltiesQuery = {
    season?: Maybe<
        { __typename?: 'Season' } & Pick<Season, 'id'> & {
                teams?: Maybe<
                    Array<
                        Maybe<
                            { __typename?: 'Team' } & Pick<
...
export type AllSeasonsListQuery = {
    allSeasons?: Maybe<
        Array<
            Maybe<
                { __typename?: 'Season' } & Pick<
...
export type SeasonByIdQuery = {
    season?: Maybe<
        { __typename?: 'Season' } & Pick<Season, 'id' | 'name' | 'state'> & {
                teams?: Maybe<
                    Array<
                        Maybe<
                            { __typename?: 'Team' } & Pick<
...
export type AllTournamentListQuery = {
    allTournaments?: Maybe<
        Array<
            Maybe<
...
export type TournamentByIdQuery = {
    tournament?: Maybe<
        { __typename?: 'Tournament' } & Pick<Tournament, 'id' | 'name'> & {
                rounds?: Maybe<
                    Array<
...
export class ScheduleAllMatchesForSeasonGQL extends Apollo.Mutation<
    ScheduleAllMatchesForSeasonMutation,
...
export class ScheduleAllMatchesForMatchDayGQL extends Apollo.Mutation<
    ScheduleAllMatchesForMatchDayMutation,
...
export class AddRankingPenaltyGQL extends Apollo.Mutation<
    AddRankingPenaltyMutation,
    AddRankingPenaltyMutationVariables
> {
...
export class RemoveRankingPenaltyGQL extends Apollo.Mutation<
    RemoveRankingPenaltyMutation,
    RemoveRankingPenaltyMutationVariables
> {
...
export class UpdatePitchContactGQL extends Apollo.Mutation<
    UpdatePitchContactMutation,
    UpdatePitchContactMutationVariables
> {
...
export class CreateMatchesForSeasonGQL extends Apollo.Mutation<
    CreateMatchesForSeasonMutation,
...
export class DeleteSeasonGQL extends Apollo.Mutation<
...
export const ReplaceTeamInSeasonDocument = gql`
    mutation ReplaceTeamInSeason(
        $season_id: String!
        $current_team_id: String!
        $replacement_team_id: String!
    ) {
        replaceTeamInSeason(
            season_id: $season_id
...
export class ReplaceTeamInSeasonGQL extends Apollo.Mutation<
    ReplaceTeamInSeasonMutation,
...
export class CalendarGQL extends Apollo.Query<
    CalendarQuery,
...
export class AllEventGQL extends Apollo.Query<
    AllEventQuery,
    AllEventQueryVariables
> {
...
export class MatchByIdGQL extends Apollo.Query<
    MatchByIdQuery,
...
export class RankingByIdGQL extends Apollo.Query<
    RankingByIdQuery,
    RankingByIdQueryVariables
> {
...
export class HallOfFameGQL extends Apollo.Query<
    HallOfFameQuery,
...
export class SeasonByIdGQL extends Apollo.Query<
    SeasonByIdQuery,
...
export class TeamByIdGQL extends Apollo.Query<
    TeamByIdQuery,
...
export class AllTournamentListGQL extends Apollo.Query<
    AllTournamentListQuery,
    AllTournamentListQueryVariables
> {
...
export class TournamentByIdGQL extends Apollo.Query<
    TournamentByIdQuery,
    TournamentByIdQueryVariables
> {
...
export class AuthenticatedUserGQL extends Apollo.Query<
